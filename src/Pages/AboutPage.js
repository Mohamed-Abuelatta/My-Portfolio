    ...
    return (
        <div className="AboutPage">
            ...
            <div className="servives-container">
                ...
                text={'Html5, Css3, BootStrap5, Sass, Scss, Less.'}
                />
                <ServicesSection image={intelligence} title={'web Development'} 
                text={'Asp.net Core, Angular 11, React.JS, JavaScript.'}
                />
                <ServicesSection image={gamedev} title={'Mobile Development'} 
                text={'Xzamaren, React Native, Android.'}
                />
            </div>
