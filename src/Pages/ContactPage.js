        ...
        <div>
            ...
            <div className="ContactPage">
                ...
                <div className="contact-sect">
                    <ContactItem icon={phone} text1={'+90 552 383 65 14'} text2={'+90 552 213 70 06'} title={'Phone'}/>
                    <ContactItem icon={email} text1={'mhmdshesht2020@hmail.com'} text2={'abuelatta.shesht@gmail.com'} title={'Email'}/>
                    <ContactItem icon={location} text1={'40-42, Mihraci ST, Ornek, Ataşehir, Istanbul Asian Side'} text2={'Istanbul, Turkey'} title={'Address'}/>
                </div>
            </div>
        </div>
    )
